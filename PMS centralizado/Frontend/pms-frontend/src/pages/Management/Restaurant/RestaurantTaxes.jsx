    ...
    <div className="space-y-4">
      <Card className="p-5 space-y-3">
        <div>
          ...
          <p className="text-sm text-slate-400">{t("mgmt.restaurantTaxes.subtitle")}</p>
        </div>
        ...
        <div className="flex justify-end">
          <button className="px-4 py-2 rounded-lg border border-white/10 text-sm bg-white/5 text-slate-200 hover:bg-white/10" disabled={saving} onClick={save}>
