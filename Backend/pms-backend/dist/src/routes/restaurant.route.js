...
import { getRestaurantConfig, listRestaurantPrinters, printRestaurantOrder, updateRestaurantConfig, closeShift, listCloses, createOrUpdateOrder, closeOrder, listSections, createSection, deleteSection, addTableToSection, deleteTableFromSection, listMenu, addMenuItem, deleteMenuItem, } from "../controllers/restaurant.controller.js";
const router = Router();
